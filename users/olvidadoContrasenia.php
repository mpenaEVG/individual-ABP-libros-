...
<body>
    <div id="login">
        <h2>Recupera contraseña</h2> <form action="/individual-ABP/index.php?controlador=verificar" method="POST">
           ...
           <?php
            ...
            <button type="button" onclick="window.location.href = '/individual-ABP/users/login.php">Volver</button>
        </form>
    </div>
</body>
</html>
